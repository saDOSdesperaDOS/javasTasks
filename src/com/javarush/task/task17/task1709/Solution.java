...
/**
 @author by Mikhe Blokhin
 Требования:
 V 1.	Класс Solution должен содержать нить MakeProposal.
 V2.	Класс Solution должен содержать нить AcceptProposal.
 V3.	Класс Solution должен содержать публичную статическую переменную int proposal.
 V4.	Программа не должна содержать synchronized методов или synchronized блоков.
